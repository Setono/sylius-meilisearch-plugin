...
/**
 * The shared contract of the admin managed "index this product attribute/option" configuration.
 * The concrete resources are IndexableAttribute and IndexableOption
 */
interface IndexableSubjectInterface extends ResourceInterface, ToggleableInterface, TimestampableInterface
{
