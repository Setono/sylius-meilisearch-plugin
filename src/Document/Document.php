...
abstract class Document
{
    ...
    /**
     * Values of fields that are added at runtime (e.g. admin-configured product attributes/options),
     * indexed by the field name. The bag is flattened to top level fields when the document is
     * normalized, so every key ends up as its own field in Meilisearch
     *
