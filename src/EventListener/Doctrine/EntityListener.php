...
{
    private ?SplObjectStorage $removeIndexableStorage = null;
    ...
    public function preRemove(LifecycleEventArgs $eventArgs): void
    {
        ...
        if (null !== $indexable) {
            $this->getRemoveIndexableStorage()->attach($indexable, $indexable->getId());
        }
    }
    ...
    public function postRemove(LifecycleEventArgs $eventArgs): void
    {
        ...
        /** @var ?int $entityId */
        $entityId = $this->getRemoveIndexableStorage()[$indexable] ?? null;
    ...
    private function getRemoveIndexableStorage(): SplObjectStorage
    {
        return $this->removeIndexableStorage ??= new SplObjectStorage();
    }
